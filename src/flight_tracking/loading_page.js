...
cover4.style.left =  0*x_ratio + "px"
cover4.style.width= 880*x_ratio + "px"
...
cover7.style.top = 187*y_ratio + "px"
cover7.style.left= 873*x_ratio + "px"
cover7.style.width= 30*x_ratio + "px"
cover7.style.height= 891*y_ratio + "px"
